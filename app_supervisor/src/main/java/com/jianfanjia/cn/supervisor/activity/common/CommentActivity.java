...
public class CommentActivity extends BaseSwipeBackActivity {
    ...
    private void getDataFormIntent() {
        ...
        LogTool.d("topicid=" + topicid  + " toUserid " + toUserid + " toDesignerid " + toDesignerid +  " section = " + section + " item" + item);
    }
