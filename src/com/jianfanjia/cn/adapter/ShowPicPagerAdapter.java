...
public class ShowPicPagerAdapter extends PagerAdapter {
	...
	public ShowPicPagerAdapter(Context context,List<String> imageList,ViewPagerClickListener viewPagerClickListener){
	...
	public Object instantiateItem(ViewGroup container,final int position) {
		...
		imageLoader.displayImage(Url.GET_IMAGE + images.get(position), imageView, options);
