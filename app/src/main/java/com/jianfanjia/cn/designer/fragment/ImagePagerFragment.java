...
import com.jianfanjia.cn.designer.adapter.PhotoPagerAdapter;
...
//        refWatcher.watch(this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new PhotoPagerAdapter(getActivity().getApplicationContext(), paths, new ViewPagerClickListener() {
            @Override
