...
public class WaterFallView extends ScrollView implements View.OnClickListener {
	...
	private void init(Context context) {
		...
		ViewGroup innerView = (ViewGroup) LayoutInflater.from(context).inflate(
				R.layout.water_fall_view_inner, null);
		...
		for (int position = 0; position < size; position++) {
			...
			if (view.getVisibility() != visibility) {
				...
				if (onItemVisibilityChangeListener != null)
					onItemVisibilityChangeListener.onVisibilityChange(this,
							position, view, visibility);
			}
		}
	...
	public void setOnItemVisibilityChangeListener(
			OnItemVisibilityChangeListener onItemVisibilityChangeListener) {
		this.onItemVisibilityChangeListener = onItemVisibilityChangeListener;
	}

	public static interface OnItemVisibilityChangeListener {
		public void onVisibilityChange(View wallView, int position, View view,
				int visibility);
	}
	...
	public static interface OnItemClickListener {
		public void onItemClick(WaterFallView waterFallView, int position,
				View view);
	}
