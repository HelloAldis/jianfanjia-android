...
import com.jianfanjia.cn.ui.adapter.RequirementItemAdapter;
...
public class ChooseItemActivity extends BaseSwipeBackActivity {
    ...
    private void getDataFromIntent() {
        ...
        if (bundle != null) {
            requestCode = bundle.getInt(IntentConstant.REQUIRE_DATA, 0);
    ...
    private void initMainView() {
        ...
        mMainHeadView.setRightTextListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent data = getIntent();
                data.putParcelableArrayListExtra(IntentConstant.RESPONSE_DATA, (ArrayList) choosedItemMap);
                setResult(RESULT_OK, data);
                appManager.finishActivity(ChooseItemActivity.this);
            }
        });
