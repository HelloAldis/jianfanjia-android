...
public class DetailPriceActivity extends BaseActivity implements OnClickListener {
    ...
    public void initView() {
        ...
        if (null != planDetailInfo) {
            ...
            project_total_price.setText("工程总造价：￥" + planDetailInfo.getProject_price_before_discount());
            project_price_after_discount.setText("工程折后价：￥" + planDetailInfo.getProject_price_after_discount());
            total_design_fee.setText("        设计费：￥" + planDetailInfo.getTotal_design_fee());
            project_price_before_discount.setText("    折后总价：￥" + planDetailInfo.getTotal_price());
        }
    }
