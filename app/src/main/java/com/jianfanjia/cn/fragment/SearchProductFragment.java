...
public class SearchProductFragment extends BaseFragment {
    ...
    private void searchProduct(int from, String searchText, ApiCallback<ApiResponse<DesignerWorksInfo>> listener) {
    ...
    private ApiCallback<ApiResponse<DesignerWorksInfo>> listener = new ApiCallback<ApiResponse<DesignerWorksInfo>>() {
