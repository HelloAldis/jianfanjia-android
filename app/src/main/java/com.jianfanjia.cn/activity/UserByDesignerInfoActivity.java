...
public class UserByDesignerInfoActivity extends BaseActivity implements
	...
	private void put_Designer_Info() {
		JianFanJiaClient.put_DesignerInfo(this, designerUpdateInfo,
...
//						uploadManager.uploadPortrait(imgPath, this);
						JianFanJiaClient.uploadImage(this, bitmap, new LoadDataListener() {
							@Override
							public void preLoad() {
							...
							public void loadSuccess(BaseResponse baseResponse) {
								if(baseResponse.getData() != null) {
									String imageid = baseResponse.getData().toString();
