...
public class ShowCheckPicActivity extends BaseActivity implements
		ViewPagerClickListener, OnPageChangeListener {
	private static final String TAG = ShowCheckPicActivity.class.getName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (bundle != null) {
			...
			imageList = bundle.getStringArrayList(CheckActivity.SHOW_LIST);
