...
public class Constant {
    ...
    //通知搜索类型
    public static final String[] ALL = {TYPE_DELAY_MSG, TYPE_CAIGOU_MSG, TYPE_SYSTEM_MSG, TYPE_AUTH_TYPE_AGRAEE, TYPE_AUTH_TYPE_DISGREE, TYPE_UID_TYPE_AGRAEE, TYPE_UID_TYPE_DISGRAEE, TYPE_PROCESS_AGRAEE, TYPE_PROCESS_DISGRAEE, TYPE_PRODUCT_AGRAEE, TYPE_PRODUCT_DISGRAEE, TYPE_PRODUCT_OFFLINE, TYPE_USER_APPOINT_MSG, TYPE_USER_CONFIRM_HOSER_MSG, TYPE_PLAN_CHOOSED_MSG, TYPE_PLAN_NOT_CHOOSED_MSG, TYPE_CONFIRM_CONTRACT_MSG, TYPE_REJECT_DELAY_MSG, TYPE_AGREE_DELAY_MSG};
    public static final String[] SYSTEM = {TYPE_SYSTEM_MSG, TYPE_AUTH_TYPE_AGRAEE, TYPE_AUTH_TYPE_DISGREE, TYPE_UID_TYPE_AGRAEE, TYPE_UID_TYPE_DISGRAEE, TYPE_PROCESS_AGRAEE, TYPE_PROCESS_DISGRAEE, TYPE_PRODUCT_AGRAEE, TYPE_PRODUCT_DISGRAEE, TYPE_PRODUCT_OFFLINE};
    public static final String[] REQUIRE = {TYPE_USER_APPOINT_MSG, TYPE_USER_CONFIRM_HOSER_MSG, TYPE_PLAN_CHOOSED_MSG, TYPE_PLAN_NOT_CHOOSED_MSG, TYPE_CONFIRM_CONTRACT_MSG};
    public static final String[] SITE = {TYPE_DELAY_MSG, TYPE_CAIGOU_MSG, TYPE_REJECT_DELAY_MSG, TYPE_AGREE_DELAY_MSG};

    public static final String[] searchMsgCountType1 = {TYPE_DELAY_MSG, TYPE_CAIGOU_MSG, TYPE_SYSTEM_MSG, TYPE_AUTH_TYPE_AGRAEE, TYPE_AUTH_TYPE_DISGREE, TYPE_UID_TYPE_AGRAEE, TYPE_UID_TYPE_DISGRAEE, TYPE_PROCESS_AGRAEE, TYPE_PROCESS_DISGRAEE, TYPE_PRODUCT_AGRAEE, TYPE_PRODUCT_DISGRAEE, TYPE_PRODUCT_OFFLINE, TYPE_USER_APPOINT_MSG, TYPE_USER_CONFIRM_HOSER_MSG, TYPE_PLAN_CHOOSED_MSG, TYPE_PLAN_NOT_CHOOSED_MSG, TYPE_CONFIRM_CONTRACT_MSG, TYPE_REJECT_DELAY_MSG, TYPE_AGREE_DELAY_MSG};
