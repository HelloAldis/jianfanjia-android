 ...
 * @Description:个人信息(设计师)
 * @date 2015-9-6 下午3:44:09
 */
public class MyDesignerInfo implements Serializable {
    ...
    private String[] dec_house_types;
    ...
    public String[] getDec_house_types() {
        return dec_house_types;
    }

    public void setDec_house_types(String[] dec_house_types) {
