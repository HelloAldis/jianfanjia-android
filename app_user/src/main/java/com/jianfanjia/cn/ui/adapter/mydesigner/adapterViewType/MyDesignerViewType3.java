package com.jianfanjia.cn.ui.adapter.mydesigner.adapterViewType;
 ...
 */
public class MyDesignerViewType3 extends RecyclerView.ViewHolder {
    ...
    public MyDesignerViewType3(View view, Context context) {
        super(view);
        ButterKnife.bind(this, view);
        this.context = context;
    }

    public static MyDesignerViewType3 build(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_item_my_designer_type1, null);
        return new MyDesignerViewType3(view, context);
    }
