...
import com.jianfanjia.cn.supervisor.activity.SettingContractActivity;
import com.jianfanjia.cn.supervisor.activity.requirement.MyProcessDetailActivity;
import com.jianfanjia.cn.supervisor.activity.requirement.PreviewBusinessRequirementActivity;
import com.jianfanjia.cn.supervisor.activity.requirement.PreviewDesignerPlanActivity;
import com.jianfanjia.cn.supervisor.activity.requirement.PreviewHomeRequirementActivity;
                            ...
                            case ITEM_GOTOO_SITE:
                                Intent gotoMyProcess = new Intent(getActivity(),
                                        MyProcessDetailActivity
                                                .class);
                                gotoMyProcess.putExtra(Global.PROCESS_INFO, process);
