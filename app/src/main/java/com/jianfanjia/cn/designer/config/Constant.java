...
public class Constant {
    ...
    //通知搜索类型
    public static final String[] ALL = {Constant.TYPE_DELAY_MSG, Constant.TYPE_CAIGOU_MSG, Constant.TYPE_SYSTEM_MSG, Constant.TYPE_AUTH_TYPE_AGRAEE, Constant.TYPE_AUTH_TYPE_DISGREE, Constant.TYPE_UID_TYPE_AGRAEE, Constant.TYPE_UID_TYPE_DISGRAEE, Constant.TYPE_PROCESS_AGRAEE, Constant.TYPE_PROCESS_DISGRAEE, Constant.TYPE_PRODUCT_AGRAEE, Constant.TYPE_PRODUCT_DISGRAEE, Constant.TYPE_PRODUCT_OFFLINE, Constant.TYPE_USER_APPOINT_MSG, Constant.TYPE_USER_CONFIRM_HOSER_MSG, Constant.TYPE_PLAN_CHOOSED_MSG, Constant.TYPE_PLAN_NOT_CHOOSED_MSG, Constant.TYPE_CONFIRM_CONTRACT_MSG, Constant.TYPE_REJECT_DELAY_MSG, Constant.TYPE_AGREE_DELAY_MSG};
    public static final String[] SYSTEM = {Constant.TYPE_SYSTEM_MSG, Constant.TYPE_AUTH_TYPE_AGRAEE, Constant.TYPE_AUTH_TYPE_DISGREE, Constant.TYPE_UID_TYPE_AGRAEE, Constant.TYPE_UID_TYPE_DISGRAEE, Constant.TYPE_PROCESS_AGRAEE, Constant.TYPE_PROCESS_DISGRAEE, Constant.TYPE_PRODUCT_AGRAEE, Constant.TYPE_PRODUCT_DISGRAEE, Constant.TYPE_PRODUCT_OFFLINE};
    public static final String[] REQUIRE = {Constant.TYPE_USER_APPOINT_MSG, Constant.TYPE_USER_CONFIRM_HOSER_MSG, Constant.TYPE_PLAN_CHOOSED_MSG, Constant.TYPE_PLAN_NOT_CHOOSED_MSG, Constant.TYPE_CONFIRM_CONTRACT_MSG};
    public static final String[] SITE = {Constant.TYPE_DELAY_MSG, Constant.TYPE_CAIGOU_MSG, Constant.TYPE_REJECT_DELAY_MSG, Constant.TYPE_AGREE_DELAY_MSG};
}
