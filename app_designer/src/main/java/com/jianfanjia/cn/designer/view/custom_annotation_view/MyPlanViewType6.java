 ...
 */
public class MyPlanViewType6 extends MyPlanViewTypeBase {
    ...
    public MyPlanViewType6(View view) {
        super(view);
        ButterKnife.bind(this, view);
    }

    public static MyPlanViewType6 build(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_item_plan_type6, null);
        return new MyPlanViewType6(view);
    }
    ...
    public void bind(Requirement requirementInfo, final ClickCallBack clickCallBack, final int position) {
        ...
        statusView.setText(getResources().getString(R.string.str_wait_upload_plan));
