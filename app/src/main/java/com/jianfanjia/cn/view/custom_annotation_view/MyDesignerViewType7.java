...
public class MyDesignerViewType7 extends RecyclerView.ViewHolder{
    ...
    public MyDesignerViewType7(View view, Context context) {
        super(view);
        ButterKnife.bind(this, view);
        this.context = context;
    }

    public static MyDesignerViewType7 build(Context context) {
    ...
    public void bind(Designer designerInfo, final ClickCallBack clickCallBack, final int position) {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                clickCallBack.click(position, MyDesignerActivityBase.CHANGE_DESIGNER);
            }
        });
