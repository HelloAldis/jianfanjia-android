...
import com.jianfanjia.cn.pulltorefresh.library.internal.BrushLoadingLayout;
import com.jianfanjia.cn.pulltorefresh.library.internal.LoadingLayout;
import com.jianfanjia.cn.pulltorefresh.library.internal.Utils;
import com.jianfanjia.cn.pulltorefresh.library.internal.ViewCompat;
    ...
    public static enum AnimationStyle {
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
            switch (this) {
                case FLIP:
                default:
                    return new BrushLoadingLayout(context, mode, scrollDirection, attrs);
                case ROTATE:
                    return new BrushLoadingLayout(context, mode, scrollDirection, attrs);
            }
        }
