...
public class Constant {
    ...
    public static final int DAILY = 2;//工地管理
    public static final int MANAGE = 3;//工地管理
    public static final int MY = 4;//我的
    ...
    public static final String DEFALUT_ADD_DIARY_PIC = DEFALUT_PIC_HEAD
            + R.mipmap.icon_diary_add_pic;
