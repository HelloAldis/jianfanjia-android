...
import static com.jianfanjia.cn.view.slidingmenu.SlidingMenu.OnClosedListener;
import static com.jianfanjia.cn.view.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	@SuppressLint("NewApi")
	protected void startAboveHide(AnimationListener listener) {
		
		final int width = getBehindWidth();
		final int offset = getResources().getDisplayMetrics().widthPixels - width;
		final float delX = offset / (float)getWidth();
...
//		animation.setInterpolator(new DecelerateInterpolator());
	...
	protected void startAboveShow(AnimationListener listener) {
