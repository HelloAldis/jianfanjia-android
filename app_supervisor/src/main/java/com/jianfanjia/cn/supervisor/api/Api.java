...
public class Api {
    ...
    public static void login(LoginRequest request, ApiCallback<ApiResponse<SuperVisor>> apiCallback, Object tag) {
        ApiClient.okPost(Url_New.getInstance().LOGIN_URL, request, apiCallback, tag);
    }

    public static void refreshSession(RefreshSessionRequest request, ApiCallback<ApiResponse<SuperVisor>>
    ...
    public static void getSuperVisorInfoDetail(GetSuperVisorRequest request, ApiCallback<ApiResponse<SuperVisor>>
            apiCallback, Object tag) {
        ApiClient.okPost(Url_New.getInstance().GET_SUPERVISOR_INFO, request, apiCallback, tag);
    }

    public static void updateSuperVisorInfo(UpdateSuperVisorRequest request, ApiCallback<ApiResponse<String>>
            apiCallback, Object tag) {
        ApiClient.okPost(Url_New.getInstance().UPDATE_SUPERVISOR_INFO, request, apiCallback, tag);
    }
