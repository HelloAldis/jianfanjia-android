...
public class DetailPriceActivity extends BaseActivity implements OnClickListener {
    ...
    public void initView() {
        ...
        if (null != planDetailInfo) {
            ...
            project_total_price.setText("工程总造价:" + planDetailInfo.getTotal_price() + "元");
            ...
            project_price_before_discount.setText("折后总价:" + planDetailInfo.getProject_price_before_discount() + "元");
