            ...
            public void click(int position, int itemType) {
                ...
                switch (itemType) {
                    case VIEW_COMMENT:
                        ...
                        startActivity(com.jianfanjia.cn.designer.activity.requirement.PingJiaInfoActivity.class, viewBundle);
                        break;
                    case COMMENT:
                        Intent commentIntent = new Intent(MyDesignerActivity.this, com.jianfanjia.cn.designer.activity.requirement.PingjiaActivity.class);
