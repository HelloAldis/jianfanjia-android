 ...
 */
@EViewGroup(R.layout.list_item_req_over_type1)
public class MyPlanViewType1 extends BaseAnnotationView {
    ...
    @ViewById(R.id.refuse_content)
    protected TextView refuseContent;

    public MyPlanViewType1(Context context) {
        super(context);
    }
