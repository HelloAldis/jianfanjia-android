...
public class CommentInfoAdapter extends BaseListAdapter<CommentInfo> {
	...
	public View initView(int position, View convertView){
		...
		if(convertView == null){
			...
			viewHolder.itemNameView = (TextView)convertView.findViewById(R.id.list_item_comment_username);
			viewHolder.itemContentView = (TextView)convertView.findViewById(R.id.list_item_comment_content);
			viewHolder.itemIdentityView = (TextView)convertView.findViewById(R.id.list_item_comment_userrole);
			viewHolder.itemTimeView= (TextView)convertView.findViewById(R.id.list_item_comment_pubtime);
			viewHolder.itemHeadView = (ImageView)convertView.findViewById(R.id.list_item_comment_userhead);
		...
		if(commentInfo.getUserImageUrl() != null){
			ImageLoader.getInstance().displayImage(commentInfo.getUserImageUrl(), viewHolder.itemHeadView);
		}else{
			viewHolder.itemHeadView.setImageResource(R.drawable.site_listview_item_finish_circle);
		}
		return convertView;
	}
