 ...
 */
public class MyPlanViewType1 extends MyPlanViewTypeBase{
    ...
    public MyPlanViewType1(View view) {
        super(view);
        ButterKnife.bind(this, view);
    }

    public static MyPlanViewType1 build(Context context){
        View view = LayoutInflater.from(context).inflate(R.layout.list_item_plan_type1,null);
        return new MyPlanViewType1(view);
    }
