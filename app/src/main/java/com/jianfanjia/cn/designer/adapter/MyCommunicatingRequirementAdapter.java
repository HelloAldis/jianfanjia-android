 ...
 */
public class MyCommunicatingRequirementAdapter extends RecyclerViewAdapterBase<OrderDesignerInfo, View> {
    ...
    public MyCommunicatingRequirementAdapter(Context context, ClickCallBack cickCallBack) {
