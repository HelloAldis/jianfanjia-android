package com.jianfanjia.cn.supervisor.business;
...
public class DataManagerNew {
    ...
    public SuperVisor getOwnerInfoById(String ownerId) {
        return (SuperVisor) sharedPreferdata.getValue(ownerId);
    }

    public void setOwnerInfo(SuperVisor ownerInfo) {
    ...
    public void saveLoginUserBean(SuperVisor userBean) {
     ...
     * @param designer
     */
    public static void loginSuccess(SuperVisor designer) {
