...
//	public static String SEVER_PORT = "8888";
    ...
    // 登录
    public static final String LOGIN_URL = HTTPROOT + "designer_login";
    // 注册
    public static final String REGISTER_URL = HTTPROOT + "designer_signup";
    // 获取短信验证码
    ...
    // 评价装修流程
    public static final String ADD_COMMENT = HTTPROOT
            + "add_comment";
    //用户获取留言评论并标记为已读
