...
public class Constant {
    ...
    public static final String CROP_PATH = com.jianfanjia.common.tool.FileUtil.IMAG_PATH + "/cropped.jpg";// 截图的图片路径
    ...
    public static final String TYPE_CONFIRM_CHECK_MSG = "21";//业主确认阶段验收提醒
    ...
    public static final String[] ALL = {TYPE_DELAY_MSG, TYPE_CAIGOU_MSG, TYPE_SYSTEM_MSG, TYPE_AUTH_TYPE_AGRAEE,
            ...
            TYPE_CONFIRM_CONTRACT_MSG, TYPE_REJECT_DELAY_MSG, TYPE_AGREE_DELAY_MSG, TYPE_CONFIRM_CHECK_MSG};
    ...
    public static final String[] SITE = {TYPE_DELAY_MSG, TYPE_CAIGOU_MSG, TYPE_REJECT_DELAY_MSG,
            TYPE_AGREE_DELAY_MSG, TYPE_CONFIRM_CHECK_MSG};
